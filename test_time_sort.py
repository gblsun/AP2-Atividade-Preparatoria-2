...
start_time_10_desord_sort = time.time()
lista_10_Desordenado.sort()
print(lista_10_Desordenado)
end_time_10_desord_sort = time.time()

# Sort: Lista Desordenada: lista_25_Desordenado
start_time_25_desord_sort = time.time()  
lista_25_Desordenado.sort()
print(lista_25_Desordenado)
end_time_25_desord_sort = time.time()

# Sort: Lista Desordenada: lista_50_Desordenado
start_time_50_desord_sort = time.time()
lista_50_Desordenado.sort()
print(lista_50_Desordenado)
end_time_50_desord_sort = time.time()

# Sort: Lista Desordenada: lista_100_Desordenado
start_time_100_desord_sort = time.time()
lista_100_Desordenado.sort()
print(lista_100_Desordenado)
end_time_100_desord_sort = time.time()

# Sort: Lista Desordenada: lista_1000_Desordenado
start_time_1000_desord_sort = time.time()
lista_1000_Desordenado.sort()
print(lista_1000_Desordenado)
end_time_1000_desord_sort = time.time()

# Sort: Lista quase ordenada ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

# Sort: Lista quase ordenada: lista_10_QuaseOrdenado
start_time_10_QuaseOrd_sort = time.time()
lista_10_QuaseOrdenado.sort()
print(lista_10_QuaseOrdenado)
end_time_10_QuaseOrd_sort = time.time()

# Sort: Lista quase ordenada: lista_25_QuaseOrdenado
start_time_25_QuaseOrd_sort = time.time()
lista_25_QuaseOrdenado.sort()
print(lista_25_QuaseOrdenado)
end_time_25_QuaseOrd_sort = time.time()

# Sort: Lista quase ordenada: lista_50_QuaseOrdenado
start_time_50_QuaseOrd_sort = time.time()
lista_50_QuaseOrdenado.sort()
print(lista_50_QuaseOrdenado)
end_time_50_QuaseOrd_sort = time.time()

# Sort: Lista quase ordenada: lista_100_QuaseOrdenado
start_time_100_QuaseOrd_sort = time.time()
lista_100_QuaseOrdenado.sort()
print(lista_100_QuaseOrdenado)
end_time_100_QuaseOrd_sort = time.time()

# Sort: Lista quase ordenada: lista_1000_QuaseOrdenado
start_time_1000_QuaseOrd_sort = time.time()
lista_1000_QuaseOrdenado.sort()
print(lista_1000_QuaseOrdenado)
end_time_1000_QuaseOrd_sort = time.time()

# Sort: lista inversamente ordenada ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

# Sort: lista inversamente ordenada: lista_10_InversamenteOrdenado
start_time_10_InversamenteOrd_sort = time.time()
lista_10_InversamenteOrdenado.sort()
print(lista_10_InversamenteOrdenado)
end_time_10_InversamenteOrd_sort = time.time()

# Sort: lista inversamente ordenada: lista_25_InversamenteOrdenado
start_time_25_InversamenteOrd_sort = time.time()
lista_25_InversamenteOrdenado.sort()
print(lista_25_InversamenteOrdenado)
end_time_25_InversamenteOrd_sort = time.time()

# Sort: lista inversamente ordenada: lista_50_InversamenteOrdenado
start_time_50_InversamenteOrd_sort = time.time()
lista_50_InversamenteOrdenado.sort()
print(lista_50_InversamenteOrdenado)
end_time_50_InversamenteOrd_sort = time.time()

# Sort: lista inversamente ordenada: lista_100_InversamenteOrdenado
start_time_100_InversamenteOrd_sort = time.time()
lista_100_InversamenteOrdenado.sort()
print(lista_100_InversamenteOrdenado)
end_time_100_InversamenteOrd_sort = time.time()

# Sort: lista inversamente ordenada: lista_1000_InversamenteOrdenado
start_time_1000_InversamenteOrd_sort = time.time()
lista_1000_InversamenteOrdenado.sort()
print(lista_1000_InversamenteOrdenado)
end_time_1000_InversamenteOrd_sort = time.time()
